          ...
          echo "<table>
            ...
            for( $i = 0; $i < sizeof($result); $i++){
                echo"<tr>
                        ...
                        <td><a href='http://.hol.es/aanvraag/?id=".$result[$i]["1e_slot"]."&action=update'>
                        <img src='http://.hol.es/wp-content/plugins/Organisator-aanmelden-plugin/images/vink.png' alt='vink'</a></td>
                        <td><a href='http://.hol.es/aanvraag/?id=".$result[$i]["id"]."&action=delete'>
                        <img src='http://.hol.es/wp-content/plugins/Organisator-aanmelden-plugin/images/drop.png' alt='cross'</a></td>
                    </tr>" ;  
            }
            echo "</table>";
            echo "</form>";
